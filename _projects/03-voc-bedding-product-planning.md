...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-01.png" alt="침구 관리의 번거로움을 해결하는 침구 리프레셔 — BX/CX/DX 프로젝트 로드맵">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-02.png" alt="수면 개선 노력 2x2 매트릭스 — 내적/외적 요인, 능동적/수동적 관리">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-03.png" alt="'침구관리' 연관어 네트워크 분석">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-04.png" alt="아토피피부염 진단 연별 추이 (표준화율)">
  <figcaption>아토피피부염 진단 연별 추이</figcaption>
</figure>

<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-05.png" alt="기존 침구 관리 방식(스타일러, 세탁기, 건조기 등)의 핵심 한계 및 불편사항">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-06.png" alt="검색 키워드, 데이터 식별 전략, 데이터 수집 범위와 채널별 건수">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-07.png" alt="TF-IDF 상위 토큰 표와 워드클라우드">
  <figcaption>TF-IDF 빈도 분석 및 워드클라우드</figcaption>
</figure>

<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-08.png" alt="클러스터 수(K)에 따른 Silhouette Score 변화 그래프">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-09.png" alt="Actor 0~2 — 냄새 제거 관리형, 침구 위생 가전 활용형, 침구 종류별 관리형">
  <figcaption>Actor 0~2</figcaption>
</figure>

<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-10.png" alt="Actor 3~6 — 숙소 침구 위생 중시형, 알레르기·피부 민감형, 가족 위생 관리형, 스마트 가전 기반 숙면 추구형">
  <figcaption>Actor 3~6</figcaption>
</figure>

<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-11.png" alt="Importance-Satisfaction 기반 기회영역 산점도 그래프">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-12.png" alt="4D-CX 프레임워크 — 정신적 공간, 물리적 공간, 문화적 공간, 시스템적 공간">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-14.png" alt="LG E:VE — Everyday Volume Experience 컨셉 침대 렌더링">
  <figcaption>LG E:VE (Everyday Volume Experience)</figcaption>
</figure>

<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-13.png" alt="침대 하부 서랍형 침구 케어 디바이스 컨셉 렌더링">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-15.png" alt="스마트 홈 베딩 케어 앱 UI(청결도 리포트)와 UVC 케어·고온 스팀 살균·향기 케어 제품 렌더링">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-16.png" alt="위생 케어 심도 대비 사용자 편리도 기준 LG E:VE 경쟁 포지셔닝 매트릭스">
...
<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-17.png" alt="진드기·세균 제거율, 피부 트러블 기록, 월별 침구 관리 시간 변화 그래프">
  <figcaption>고객 가치 지표</figcaption>
</figure>

<figure>
  <img src="/assets/images/projects/03-voc-bedding/img-18.png" alt="스마트 기능 활용 정도, NPS, AI 기능 활용률 그래프">
